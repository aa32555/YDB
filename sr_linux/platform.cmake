...
if(${bits} EQUAL 32)
  ...
  elseif("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "riscv64")
    list(APPEND gt_src_list sr_riscv)
  else()
...
if ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
  ...
  if (CMAKE_COMPILER_IS_GNUCC)
    ...
    if (NOT (("${arch}" STREQUAL "armv6l") OR ("${arch}" STREQUAL "aarch64") OR ("${arch}" STREQUAL "riscv64") ))
      ...
      message("*** Production build not using LTO due to issues building on armv6l or aarch64 and riscv64 (see #498)")
    endif()
  endif()
endif()

...
static	char	gtm_key_insert[] = "\033[2~"; /* old value "" */
static	char	gtm_key_home[] = "\033OH";     /* if not working, please, try "\033[1~" or "\033[H" */
static	char	gtm_key_end[] = "\033OF";     /* if not working, please, try "\033[4~" or "\033[F" */
